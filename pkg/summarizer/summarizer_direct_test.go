...
func TestSummarizer_Direct(t *testing.T) {
	...
	summarizer, err := NewSummarizer(client, 100, true, dummyCmd)
	if err != nil {
	...
	_, err = summarizer.Summarize(context.Background(), longText, prompt)
	if err != nil {
